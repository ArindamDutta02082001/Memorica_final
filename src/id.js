...
function Id()
{
  ...
  //   ***********func to get mem id**************
   ...
   <h3><i className="fas fa-phone-alt"></i> or <i class="fas fa-sms"></i> <code> 8016216564</code></h3>
      <input type='text' placeholder='Enter your Original Name' name='' id='' onChange={(e) => { setgetid_name(e.target.value) }} />
      <input id='butt'
        type='button' onClick={() => {
          getting_memory_id()
        }} value='get id'
      ...
      <Link id='lo' to='/opera'>Go Back</Link>
      </div>)
}
